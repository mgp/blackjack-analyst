...
public class TrueCountBetTable {
	public static void main(String[] args) {
		...
		if (args.length < 2) {
			System.err.println("Usage: java TrueCountBetTable [verbose] <num_rounds> "
		...
		for (int i = next_arg; i < args.length; ++i) {
			...
			Player new_player = new Player(new TrueCountBetPlayer(), player_name);
